...
export const useDraggableSort = ({ horizontal = false, initialOrder = [], onOrderChange, onOrderUpdate, shouldSwapWorklet, }) => {
    ...
    useAnimatedReaction(() => [draggableActiveId.value, draggableActiveLayout.value], ([nextActiveId, nextActiveLayout], prev) => {
